...
Ext.define('ianMizi.view.AyohaMerchantInfo.FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram', {
...
'        ',
'        <!-- Action Button -->',
'        <div style="margin: -20px 0px 0px 0px;" onclick="FloatPanel_AyohaMerchantInfo_DiscountCardLoyaltyProgram_OpenDiscountCard(`{MembershipCardCode}`)" >',
//'{ButtonBottomDisplay}',
