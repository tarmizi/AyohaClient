...
Ext.define('ianMizi.view.AyohaMerchantInfo.FloatPanel_AyohaMerchantInfo_PointCardLoyaltyProgram', {
                    ...
                    
                    {
                       ...
                       cls: 'gapped-grouped-list', // <-- ADD THIS CLASS             // <-- scope styles
                        ...
                        itemTpl: '<div class="myContent" style="background-color:white;width:101%;height:100px;">' +
                         ...
                         '<table style="border-collapse:collapse;border-spacing:0;width:108%;background-color:white;margin:-37px 0px 0px -15px;height:100px; border-left: 2px solid rgba(0,0,0,0.3) ;border-right: 2px solid rgba(0,0,0,0.3);box-shadow: 0px 10px 10px rgba(0,0,0,0.5)"><tr onclick="FloatPanel_AyohaMerchantInfo_PointCardLoyaltyProgram_OpenMerchantLoyaltyProgram_EnterpriseAccNo(`{EnterpriseAccNo}`)"><td style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:0px 7px;border-style:none;border-width:0px;overflow:hidden;word-break:normal;width:25%;vertical-align:center"><img src="{ImgPath}" width="70px" height="70px" alt="Company Name"></td><td style="font-family:Arial, sans-serif;font-size:12px;font-weight:bold;padding:0px 0px;border-style:none;border-width:0px;overflow:hidden;word-break:normal;width:80%;vertical-align:center">{ItemName}<br>{ItemPoint}</td></tr></table>'
...
function FloatPanel_AyohaMerchantInfo_PointCardLoyaltyProgram_OpenMerchantLoyaltyProgram_EnterpriseAccNo(val) {

    // FloatPanel_AyohaMerchantInfo_PointCardLoyaltyProgram_NotificationShow(ID);
     //  FloatPanel_AyohaMerchantInfo_PointCardLoyaltyProgramHide();
     globalsetMessage_toBeAyohaMember_tag="MerchantLoyaltyCampaign";
 
     var StampCampaignCode = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var StampContent = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var StampContentNote = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var StampContentSequence = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var EnterpriseName = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var CountRow = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var EndDate = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var StartDate = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var StampRuleRemarks = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var IsStampRulePopUp = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var StampCampaignName = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var EnterpriseAccNo= _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var StampContentFinal = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var CountStampYES = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var EnterprisesLogo = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var MembershipCardCode = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var CountStar = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var CountReviewer = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
     var MembershipCardFeePaymentCycle = _DataStore_MerchantLoyaltyCampaign_LoadPointCardLoyaltyStore.findRecord('EnterpriseAccNo', val, 0, false, false, true);
...
function FloatPanel_AyohaMerchantInfo_PointCardLoyaltyProgramAdjustHeight() {
   ...
   // Ext.getCmp('FloatPanel_AyohaMerchantInfo_PointCardLoyaltyProgramID').setHeight(x + 40);
   // Ext.getCmp('FloatPanel_AyohaMerchantInfo_PointCardLoyaltyProgramListListID').setHeight(newHeights);
