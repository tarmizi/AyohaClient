...
Ext.define('ianMizi.view.AyohaMerchantInfo.FloatPanel_AyohaMerchantInfo_LoyaltyProgram', {
        ...
        items: [
           ...
           
            {
                ...
                items: [
                  ...
                  //         '<tr>' +
                  //         // Stamp 1
                  //         '<td style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:5px 7px;border-style:none;overflow:hidden;word-break:normal;width:33.33%;vertical-align:top;text-align:center;" onclick="FloatPanel_AyohaMerchantInfo_LoyaltyProgram_OpenMerchantLoyaltyProgram({ID1})">{ModifiedStampContent1}</td>' +
                  //         // Stamp 2
                  //         '<td style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:5px 7px;border-style:none;overflow:hidden;word-break:normal;width:33.33%;vertical-align:top;text-align:center;" onclick="FloatPanel_AyohaMerchantInfo_LoyaltyProgram_OpenMerchantLoyaltyProgram({ID2})">{ModifiedStampContent2}</td>' +
                  //         // Stamp 3
                  //         '<td style="font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:5px 7px;border-style:none;overflow:hidden;word-break:normal;width:33.33%;vertical-align:top;text-align:center;" onclick="FloatPanel_AyohaMerchantInfo_LoyaltyProgram_OpenMerchantLoyaltyProgram({ID3})">{ModifiedStampContent3}</td>' +
                  //         '</tr>' +
