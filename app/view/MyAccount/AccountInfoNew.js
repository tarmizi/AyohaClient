                                                   ...
                                                   items: [
                                                    {
                                                        ...
                                                        html: '<link href="https://versilani.com/CRCSS/ratchet.css" rel="stylesheet"/><label for="imageUpload" class="btn btn-primary btn-block btn-outlined">Upload Picture Profile</label><input type="file" id="imageUpload" accept="image/*" style="display: none" onchange="EnableuploadPicProfile()" />',
