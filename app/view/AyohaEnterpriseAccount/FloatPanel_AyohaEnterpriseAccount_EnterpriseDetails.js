...
function FloatPanel_AyohaEnterpriseAccount_EnterpriseDetails_SaveAyohaEnterpriseAccount(RowStatus) {
    ...
    console.log(gile);
    var ImgPaths = "https://versilani.com/AyohaImgCard/Logo/" + GetEnterpriseAccNo() + "/" + document.getElementById('input-FloatPanel_AyohaEnterpriseAccount_EnterpriseDetails_EnterpriseLogoName').value;
